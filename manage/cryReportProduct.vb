...
Public Class cryReportProduct
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "manage.cryReportProduct.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryReportProduct
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryReportProduct = New cryReportProduct()
        rpt.Site = Me.Site
        Return rpt
    End Function
